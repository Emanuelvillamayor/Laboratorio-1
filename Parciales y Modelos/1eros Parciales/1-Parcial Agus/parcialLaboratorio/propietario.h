 ...
 *
 */
void cargarHarcodePropietario(ePropietario listadoPropietarioPropietario[],int tamanio);
 ...
 *
 */
void altaPropietario(ePropietario listadoPropietarioPropietario[],int tamanio,int indice);
